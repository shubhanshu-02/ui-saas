-- CreateEnum
CREATE TYPE "public"."Tier" AS ENUM ('DEMO', 'FREE', 'PRO');

-- CreateEnum
CREATE TYPE "public"."MessageType" AS ENUM ('USER', 'ASSISTANT', 'ERROR');
...
-- CreateTable
CREATE TABLE "public"."SavedComponent" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "code" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."SavedComponent" ADD CONSTRAINT "SavedComponent_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
